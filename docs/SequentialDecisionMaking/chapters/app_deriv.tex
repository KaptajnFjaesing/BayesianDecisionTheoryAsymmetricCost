...
\begin{equation}
	\begin{split}
		\frac{dC}{dU_m} = \sum_{t=1}^{\infty}\gamma_{\text{disc}}^{t}\bigg(h_t1_{N_t\geq 0}+c_t(1_{N_t\geq 0}-1)\bigg)\sum_{t'=1}^t\delta_{t'-L,m}.
	\end{split}
\end{equation}
...
meaning
\begin{equation}
	\frac{dC}{dU_m} = \sum_{t=L+m}^{\infty}\gamma_{\text{disc}}^{t}(h_t1_{N_t\geq 0}+c_t(1_{N_t\geq 0}-1)).
	\label{eq:deriv_3a}
\end{equation}
